...
type Player struct {
	...
	// целых миллисекундах: это число видят лобби и админка, и его же сервер отдаёт клиенту
	// в теле зонда, чтобы у игрока в углу экрана стояло ровно то же самое.
	// Заполняется в internal/hub/ping.go.
	RTT        time.Duration
